...
const { createTenantSchema, updateTenantSchema, listTenantsQuerySchema } = require("./tenants.schemas");

const router = express.Router();

router.use(auth);

router.get("/", authorize([ROLES.SUPER_ADMIN]), validate(listTenantsQuerySchema, "query"), controller.listTenants);
