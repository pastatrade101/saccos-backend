...
router.post("/dividend-allocation", authorize([ROLES.SUPER_ADMIN], { allowInternalOps: false }), requireFeature("dividends_enabled"), validate(dividendAllocationSchema), idempotency, controller.dividendAllocation);
